  ...
  private calculateBundlePricing(bundleTransactions: Array<BlocksApiResponseTransactionDetails | TransactionSimulation>, baseFee: bigint) {
    const bundleGasPricing = bundleTransactions.reduce(
      (acc, transactionDetail) => {
        ...
        const gasPricePaidBySearcher = BigInt('gas_price' in transactionDetail ? transactionDetail.gas_price : transactionDetail.gasPrice)
        const priorityFeeReceivedByMiner = gasPricePaidBySearcher - baseFee
        ...
        return {
          ...
          gasFeesPaidBySearcher: acc.gasFeesPaidBySearcher + gasPricePaidBySearcher * BigInt(gasUsed),
          priorityFeesReceivedByMiner: acc.priorityFeesReceivedByMiner + priorityFeeReceivedByMiner * BigInt(gasUsed),
